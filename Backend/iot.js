...
// Ethereum settings
const INFURA_URL = 'http://localhost:3001';
...
const ABI = JSON.parse(fs.readFileSync(path.resolve(__dirname, 'Energy_Trading\scaffold-eth-2\packages\hardhat\artifacts\contracts\EnergyTradingL2.sol\EnergyTradingL2.json')));
